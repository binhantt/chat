...
export async function PATCH(
  ...
  try {
    ...
    const res = await fetch(`${BACKEND_URL}/api/chat/conversations/${conversationId}/read`, {
      method: "PATCH",
      headers: {
...
export async function DELETE(
  ...
  try {
    ...
    const res = await fetch(`${BACKEND_URL}/api/chat/conversations/${conversationId}/block`, {
      method: "PATCH",
      headers: {
        "Content-Type": "application/json",
        "Cookie": cookieStore,
